...
The mean of daily steps is `r daily_steps_mean` while the median is `r daily_steps_median`.
...
The 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps is the `r max_interval$interval` with `r max_interval$mean` steps.
...
In the dataset the feature "steps" has `r steps_missing_values` missing values.
...
The mean of daily steps is `r daily_steps_mean_no_NA` while the median is `r daily_steps_median_no_NA`.
...
The 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps is the `r max_interval_no_NA$interval` with `r max_interval_no_NA$mean` steps.
